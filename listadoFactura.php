...
echo "<form method='post' name='selectFactura' action='selectFacturaDatos.php'>
<fieldset id='eliminar'>
<select name='selectFactura'>";
...
echo "</fieldset><input id='boton'  type='submit' value='SELECCIONAR'>";
